                            ...
                            <form class="form-horizontal" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="id_categorie" name="id_categorie" placeholder="ID Categorie" value="<?PHP echo $id_categorie ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Nom Categorie</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nom_categorie" placeholder="Nom Categorie" name="nom_categorie" value="<?PHP echo $nom_categorie ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
