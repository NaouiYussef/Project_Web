...
<body id="page-top">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="club.php">Clubs</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="shop.php">Boutique</a></li>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <form method="POST" id="contactForm" name="sentMessage" novalidate="novalidate" action="bach.php">
                ...
                <div class="text-center">
                    <div id="success"></div>
                    <button  type="submit" onclick="ValidateEmail(document.sentMessage.email)">Send Message</button>
                </div>
            </form>
        </div>
    </section>
