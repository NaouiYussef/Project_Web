...
<?php
    ...
    )
    {
            ...
            header('refresh:1;url=../../back/view/tables.php');
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="needs-validation" action="" method="POST" novalidate="">
                                                ...
                                                <div class="mb-3">
                                                    <label for="reference">Gym Email</label>
                                                    <div class="input-group">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="GymPics" class="form-control" id="taille" placeholder="Taille"value="<?php echo $gym['GymPics']; ?>">
                                                </div>
                                                <div class="mb-3">
