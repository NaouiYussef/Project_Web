                                ...
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- <input type="checkbox" class="custom-control-label" onclick="myFunction()">Show Password -->
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" id="rememberPasswordCheck" type="checkbox" onclick="myFunction()" />
                                                <script>
                                                    function myFunction() {
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                            ...
                                            <input class="btn btn-primary" type="submit" value="Login" href="logged.php">
                                        </div>
                                    </form>
                                </div>
